...
header-includes: \usepackage[sfdefault, condensed]{roboto}
urlcolor: blue
---
...
![Figure 1. Model Structure](Model Structure.png)

# Model characteristics and parameters

```{r Model Characteristics and Parameters}
...
run_model <- function(parms){
  ...
  for (i in 2:time_horizon) {
    ...
    trans_svr_LS[,,i] <- trans_svr_LS[,,i-1] * transition_matrix_svr[,,i]
  }
...
```{r Probabilistic Sensitivity Analysis}
